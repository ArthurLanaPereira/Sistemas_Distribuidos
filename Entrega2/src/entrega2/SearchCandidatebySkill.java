...
public class SearchCandidatebySkill {
    public static void handleSearchCandidatebySkill(BufferedReader reader, PrintWriter out, BufferedReader in, String token) throws IOException {
    	
    	System.out.println("Digite a Habilidade que pesquisa:"); //Se quiser pesquisar mais de uma, separar por ','
